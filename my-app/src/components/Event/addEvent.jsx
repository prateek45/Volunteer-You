      ...
      <div className="body">
        ...
        <fieldset className="section">
          <div className="form-row">
            ...
            <input type="number" min={0} max={10000} step={1} defaultValue={1} />
          </div>
        </fieldset>
        <fieldset className="section">
          <div className="form-row">
            <h2 className="title">Event Date</h2>
            <input type="date" defaultValue="2021-03-30" />
          </div>
        </fieldset>
        <fieldset className="section">
          <div className="form-row">
              ...
              <div id="upload_btn" className="button">
                ...
                <div>
                  <input
                    ...
                    id="upMultilImages"
                    multiple="multiple"
                    onchange="javascript:multiImagePreview();"
                    accept="image/*" />
                  <div id="picViewsBox" />
                </div>
              </div>
        ...
        <button
          className="button1"
          type="button"
          onclick="alert('Post successfully!')"
        >
          Add now
        </button>
      </div>
